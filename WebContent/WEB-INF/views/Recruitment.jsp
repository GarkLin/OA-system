	...
	<div class="bodywrapper">
		...
		<div class="vernav2 iconmenu">
			<ul>
				...
				<li class="current"><a href="#formsub1" class="widgets">招聘和配置</a>
					...
					<!-- 设置CELLPADDING (内文字与边框间距) 
						...
						<div id="colloaMenu2">
							<a class="textHighlight" href="Recritment?id=0"><img
								...
								入职管理</a><a href="Recritment2?id=2"><img src="images/folder.png"
								border="0"> 转正管理</a><a href="Recritment3?id=3"><img
								src="images/folder.png" border="0"> 岗位调动管理</a><a
								href="Recritment4?id=4"><img src="images/folder.png" border="0">
								离职管理</a>
						</div>
