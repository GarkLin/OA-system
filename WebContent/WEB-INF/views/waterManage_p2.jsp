...
<div class="bodywrapper">
    ...
    <div class="vernav">
    	<ul>
            ...
            <li class="current"><a href="waterManage_p2?id=2">电费管理</a></li>
							...
							<tr>
								<td><h1>
										<img style="cursor: pointer;"
											...
											src="images/menu.png"> 电费列表
									</h1></td>
								<td><img src="images/coins.gif"> 电费金额 <span
								...
								<td align="right" id="oWorkflowList"><span id="oWorkflowList1"><a
										...
										href="waterManage_P2table"><i
											class="fa fa-plus"></i> 电费登记</a></span>
								</td>
							</tr>
						</tbody>
					</table>
