...
<body class="withvernav">
	<div class="bodywrapper">
		...
		<div class="vernav iconmenu">
			<ul>
				<li class="current"><a href="Transaction" class="inbox">新建流程事务</a></li>
				<li><a href="myWait" class="drafts">待处理的事务</a></li>
				<li><a href="myList" class="trash">部署的事务</a></li>
									...
									<tbody id="treeOfNavigation">
										...
										<tr class="child_row_01">
											<td style="padding-left: 25px;"><span><img
													src="images/blank16.gif" border="0"></span> <a href="addFinance">
													<img src="images/flow.gif" border="0"> 差旅费登记
											</a></td>
											<td>&nbsp;</td>
											<td>10</td>
										...
										<tr class="child_row_01">
											<td style="padding-left: 25px;"><span><img
													src="images/blank16.gif" border="0"></span> <a href="addFinance">
													<img src="images/flow.gif" border="0"> 预借款登记
											</a></td>
											<td>&nbsp;</td>
											<td>10</td>
											<td><a href=""> <img src="images/flowChart.gif"
										...
										<tr class="child_row_02">
											<td style="padding-left: 25px;"><span><img
													src="images/blank16.gif" border="0"></span> <a href="waterManage_table">
										...
										<tr class="child_row_02">
											<td style="padding-left: 25px;"><span><img
													src="images/blank16.gif" border="0"></span> <a href="waterManage_P2table">
										...
										<tr class="child_row_03">
											<td style="padding-left: 25px;"><span><img
													src="images/blank16.gif" border="0"></span> <a href="addUserPage">
										...
										<tr class="child_row_03">
											<td style="padding-left: 25px;"><span><img
													src="images/blank16.gif" border="0"></span> <a href="Test_01">
										...
										<tr class="child_row_03">
											<td style="padding-left: 25px;"><span><img
													src="images/blank16.gif" border="0"></span> <a href="table_assessment">
										...
										<tr class="child_row_03">
											<td style="padding-left: 25px;"><span><img
													src="images/blank16.gif" border="0"></span> <a href="table_welfare">
													<img src="images/flow.gif" border="0"> 劳动合同登记
											</a></td>
											<td>&nbsp;</td>
											<td>10</td>
											<td><a href=""> <img src="images/flowChart.gif"
