						...
						<div id="myshiwu">
							<table class="tableList" border="0" cellspacing="0"
								...
								<tbody>
									...
									<s:iterator value="#list" id="assessment">
										<tr>
											...
											<td><div>
													...
													<s:if test="sta==0">
														<a
															href="${pageContext.request.contextPath }/leaveBillAction_input.action?id=<s:property value="id"/>">修改</a>
														<a
															href="leaveBillAction_delete.action?id=<s:property value="id"/>">删除</a>
														<a
