		...
		<div class="centercontent">
			...
			<div id="contentwrapper" class="contentwrapper">
				<div id="basicform" class="subcontent">
					...
					<td id="colloaContent">
							<div id="myshiwu2">
							<s:iterator value="#rtask" id="assessment">
								天数:<input type="text" name="assessment_time" value="<s:property value="assessment_time" />" disabled="true" /><br />
								原因:<input type="text" name="assessment_table" value="<s:property value="assessment_table" />" disabled="true" /><br />
								备注:<textarea name="recritment_shuoming" disabled="true" ><s:property value="assessment_way" /></textarea><br/>
						<form action="addReview?taskid=<%=id%>" method="post">
								<input type="hidden" name="review.ids" value="<%=id%>"/>
								<input type="hidden" name="review.name" value="<%=name%>"/>
								<input type="hidden" name="review.yaoqiu" value="<s:property value="assessment_way" />"/>
								 批注:<textarea name="review.message" cols="50" rows="5"></textarea>
								<br />
								<!-- 使用连线的名称作为按钮 -->
