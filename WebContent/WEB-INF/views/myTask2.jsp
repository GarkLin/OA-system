	...
	<div class="bodywrapper">
		...
		<div class="vernav iconmenu">
			<ul>
				...
				<li class="current"><a href="listTask" class="myList">部署的事务</a></li>
			</ul>
						...
						<div id="myshiwu">
							<table class="tableList" border="0" cellspacing="0"
								...
								<tbody>
									...
									<s:iterator value="#taskList" id="assessment">
										<tr>
											...
											<td><div>
													<a href="viewTaskForm2?taskid=<s:property value="id"/>&name=<s:property value="assignee" />">办理任务</a>
