...
<table style="width: 100%; height: 100%; min-width: 950px;" border="0"
	...
	<tbody>
		<tr valign="top">
			<td>&nbsp;</td>
			<td id="colloaForm">
			<form id="addElectricity" action="addElectricity" method="post">
					<div class="textBig">电费登记</div>
					<br>
					<table class="tableListBorder" style="table-layout: fixed;"
						...
						<tbody>
							<tr>
								...
								<td>
									<input type="hidden" name="water.type_id" value="2"/>
					...
					<div align="right">
						<a class="button" href="javascript:document:addElectricity.submit();">提交</a>
