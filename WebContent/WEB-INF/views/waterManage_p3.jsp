	...
	<div class="bodywrapper">
		...
		<div class="header">
			<ul class="headermenu">
				...
				<li class="current"><a href="waterManage?id=1"><span
		...
		<div class="vernav">
			<ul>
				...
				<li class="current"><a href="waterManage_p3">缴费查询</a></li>
					...
					<td id="colloaContent">
						<div id="myshiwu">
							<table class="tableList" border="0" cellspacing="0"
								...
								<tbody>
									<s:iterator value="#wlist">
										<tr>
											<td><img src="images/priority0.gif" border="0">
											<s:property value="department_is" /></td>
											<td><s:property value="type" /></td>
											<td><s:property value="pay_money" /></td>
