        ...
        <div id="contentwrapper" class="contentwrapper">
            <div id="basicform" class="subcontent">
					...
					<td id="colloaContent"><table border="0" cellspacing="0"
						...
						<div id="colloaMenu2">
							<a href="Finance1?id=1"><img
								src="images/folder.png" border="0"> 差旅费报销</a>
							<a href="Finance2?id=2"><img src="images/folder.png" border="0">
								费用报销</a>
								<a class="textHighlight" href="Finance3?id=3"><img src="images/folder.png" border="0">
								 支出报销</a>
