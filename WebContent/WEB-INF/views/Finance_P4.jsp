...
<body>
	<div class="bodywrapper">
		...
		<ul>
            ...
            <li><a href="">收入管理</a></li>
            <li class="current"><a href="">支出管理</a></li>
        </ul>
						...
						<tbody>
							<tr>
								...
								<td align="right" id="oWorkflowList"><span id="oWorkflowList1"><a
										...
										href="Finance_table4"><i
											class="fa fa-plus"></i> 支出登记</a></span>
								</td>
							</tr>
						</tbody>
					</table>
						...
						<tbody>
								<s:iterator value="#request.flist" id="water">
            							<tr>
												...
												border="0"><s:property value="finance_date"/></td>
                								<td style="text-align: right; color: rgb(204, 0, 0);"><s:property value="finance_money"/></td>
