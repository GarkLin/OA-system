	...
	<div class="bodywrapper">
		...
		<div class="vernav2 iconmenu">
			<ul>
				...
				<li class="current"><a href="widgets.html" class="widgets">招聘和配置</a></li>
			...
			<div id="contentwrapper" class="contentwrapper">
				...
				<div id="basicform" class="subcontent">
					...
					<td id="colloaContent"><table border="0" cellspacing="0"
						...
						<div id="colloaMenu2">
							<a class="textHighlight" href="Recritment?id=0"><img
								src="images/folder.png" border="0"> 招聘管理</a><a
								href="Recritment1?id=1"><img src="images/folder.png" border="0">
								入职管理</a><a href="Recritment?id=2"><img src="images/folder.png"
								border="0"> 转正管理</a><a href="Recritment?id=3"><img
								src="images/folder.png" border="0"> 岗位调动管理</a><a
								href="Recritment?id=4"><img src="images/folder.png" border="0">
								离职管理</a>
						</div>
						<div id="colloaContent2">
							...
							<table class="tableList" border="0" cellspacing="0"
								...
								<s:iterator value="#request.rbyid" id="recritment">
            							<tr>
                								<td><img src="images/priority0.gif"
												border="0"><s:property value="Recritment_content"/></td>
                								<td><s:property value="Recritment_name"/></td>
                								<td><s:property value="Recritment_manage"/></td>
                								<td><s:property value="Recritment_content"/></td>
               									<td><s:property value="Recritment_num"/></td>
