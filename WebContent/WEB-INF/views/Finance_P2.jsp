...
<div class="bodywrapper">
    ...
    <div class="vernav">
    	<ul>
            ...
            <li class="current"><a href="Finance_P2?id=5">资金管理</a></li>
        ...
        <div id="contentwrapper" class="contentwrapper">
            <div id="basicform" class="subcontent">
					...
					<td id="colloaContent"><table border="0" cellspacing="0"
						...
						<div id="colloaMenu2">
								<a href="Finance_P2?id=5"><img src="images/folder.png" border="0">
								 预借款信息</a>
								<a href="Finance_P21?id=6"><img src="images/folder.png" border="0">
								 资金调拨信息</a>
