		...
		<tbody>
			<tr valign="top">
				...
				<td id="colloaForm"><div class="formTaskflowContainer">
						<form class="formTaskflow" action="recritmentUpdate" method="post">
							...
							<div>
								<table align="center" class="tableListBorder"
									...
									<tbody>
									<input type="hidden" name="recritment.recritment_id" value="${recritment.recritment_id}"/>
										<tr>
											...
											<td id="dbf.positionX" dbf.type="required"><input
												...
												name="recritment.recritment_name" value="${recritment.recritment_name}"></td>
											<td style="text-align: center;"><span
												style="color: rgb(255, 0, 0);">*</span>所属部门</td>
											<td id="dbf.positionX" dbf.type="required"><input
												class="fieldEditable" id="e.dbf.positionX"
												name="recritment.recritment_manage" value="${recritment.recritment_manage}"></td>
										</tr>
										<tr>
											<td style="text-align: center;"><span
											...
											<td id="dbf.positionX" dbf.type="required"><input
												class="fieldEditable" id="e.dbf.positionX"
												name="recritment.recritment_content" value="${recritment.recritment_content}"></td>
											<td style="text-align: center;"><span
												style="color: rgb(255, 0, 0);">*</span>申请时间</td>
											<td id="dbf.positionX" dbf.type="required"><input
												class="fieldEditable" id="e.dbf.positionX"
												name="recritment.recritment_time" value="${recritment.recritment_time}"></td>
										</tr>
										<tr>
											<td style="text-align: center;"><span
												style="color: rgb(255, 0, 0);">*</span>需求人数</td>
											<td id="dbf.number0" dbf.type="number,required" dbf.source=""><input
												class="fieldEditable" id="e.dbf.number0" value="0"
												name="recritment.recritment_num" value="${recritment.recritment_num}"></td>
											<td style="text-align: center;"><span
												style="color: rgb(255, 0, 0);">*</span>希望到岗日期</td>
											<td id="dbf.positionX" dbf.type="required"><input
												class="fieldEditable" id="e.dbf.positionX"
												name="recritment.recritment_date" value="${recritment.recritment_date}"></td>
										</tr>
										<tr>
											<td style="text-align: center;">招聘原因说明</td>
											<td id="招聘原因说明" colspan="3" dbf.type="" dbf.source=""><textarea
													class="fieldEditable" id="e.招聘原因说明" style="height: 80px;"
													name="recritment.recritment_shuoming">${recritment.recritment_shuoming}</textarea></td>
										</tr>
										<tr>
											<td style="text-align: center;">工作内容及职责</td>
											<td id="工作内容及职责" colspan="3" dbf.type="" dbf.source=""><textarea
													class="fieldEditable" id="e.工作内容及职责" style="height: 80px;"
													name="recritment.recritment_neirong">${recritment.recritment_neirong}</textarea></td>
										</tr>
										<tr>
											<td style="text-align: center;">外语要求</td>
											<td id="外语要求"><input class="fieldEditable" id="e.外语要求"
												name="recritment.recritment_English" value="${recritment.recritment_English}"></td>
											<td style="text-align: center;">工作地点</td>
											<td id="工作地点"><input class="fieldEditable" id="e.工作地点"
												name="recritment.recritment_address" value="${recritment.recritment_address}"></td>
										</tr>
										<tr>
											<td style="text-align: center;">状态</td>
											<td id="状态"><input class="fieldEditable" id="e.状态"
												name="recritment.sta" value="${recritment.sta}"></td>
											<td style="text-align: center;">性别</td>
											<td id="性别"><input class="fieldEditable" id="e.性别"
												name="recritment.recritment_gender" value="${recritment.recritment_gender}"></td>
										</tr>
										<tr>
											<td style="text-align: center;">学历</td>
											<td id="dbf.positionX" dbf.type="required"><input
												class="fieldEditable" id="e.dbf.positionX"
												name="recritment.recritment_xueli" value="${recritment.recritment_xueli}"></td>
											<td style="text-align: center;">专业</td>
											<td id="专业"><input class="fieldEditable" id="e.专业"
												name="recritment.recritment_zhuanye" value="${recritment.recritment_zhuanye}"></td>
										</tr>
										<tr>
											...
											<td id="工作经验" colspan="3" dbf.type="" dbf.source=""><textarea
													...
													name="recritment.recritment_jingyan">${recritment.recritment_jingyan}</textarea></td>
										</tr>
										<tr>
											...
											<td id="行业背景" colspan="3" dbf.type="" dbf.source=""><textarea
													...
													name="recritment.recritment_beijing">${recritment.recritment_beijing}</textarea></td>
										</tr>
										<tr>
											...
											<td id="其他要求" colspan="3" dbf.type="" dbf.source=""><textarea
													...
													name="recritment.recritment_yaoqiu">${recritment.recritment_yaoqiu}</textarea></td>
										</tr>
									</tbody>
								</table>
							</div>
